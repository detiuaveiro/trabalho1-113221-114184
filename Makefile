...
PROGS = imageTool imageTest imageLocateMatchBenchmarking
...
imageLocateMatchBenchmarking: image8bit.o instrumentation.o

imageLocateMatchBenchmarking.o: image8bit.h instrumentation.h
